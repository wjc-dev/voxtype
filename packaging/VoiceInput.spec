...
app = BUNDLE(
    ...
    info_plist={
        ...
        "NSMicrophoneUsageDescription": "Veyqa 需要麦克风权限，才能把你的语音实时转成文字。",
        "NSAppleEventsUsageDescription": "Veyqa 需要辅助功能权限，才能在当前光标处实时写入转写文字。",
        "NSHumanReadableCopyright": "Veyqa contributors",
    },
)
